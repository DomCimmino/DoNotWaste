...
public interface IAssetScoreBuildingApi
{
    ...
    [Get("/api/v2/buildings/{buildingId}/recommendations")]
    Task<List<Recommendation>> GetRecommendations(int buildingId, [Body(BodySerializationMethod.Serialized)] BaseRequest baseRequest);
